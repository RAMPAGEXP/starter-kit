...
```bash
npx create-next-app -e https://github.com/RAMPAGEXP/starter-kit my-cosmwasm-dapp
# or
yarn create next-app -e https://github.com/RAMPAGEXP/starter-kit my-cosmwasm-dapp
```
...
docker run -it \
  ...
  -p 26657:26657 \
  -e STAKE_TOKEN=urxpx \
  ghcr.io/RAMPAGEXP/rxp:v1.0.0-alpha \
  ./setup_and_run.sh rxp16g2rahf5846rxzp3fwlswy08fz8ccuwk03k57y
```

More information can be found [in the RXP docs here](https://docs.rxpnetwork.io/smart-contracts-and-rxpd-development/rxpd-local-dev-setup).
